...
- **KDB·iM·부산·새마을금고·수협·토스 심볼/워드마크**: 공식 BI 페이지(또는 Wikimedia)에서 raster 자산을 받아 `potrace`로 모노크롬 벡터 트레이싱한 후 브랜드 컬러로 채색했습니다. 그라데이션은 보존되지 않으나 실루엣과 컬러는 공식 자산과 일치합니다.
